                    ...
                    <Col lg="4">
                      <Card className="card-lift--hover shadow border-0 h-100">
                        ...
                        <CardBody className="py-5">
                          ...
                          <Link className='btn btn-outline-primary btn-sm float-right mt-4' to={"/product-idea"}>Learn more</Link>
                    ...
                    <Col lg="4">
                      <Card className="card-lift--hover shadow border-0 h-100">
                        ...
                        <CardBody className="py-5">
                          ...
                          <Link className='btn btn-outline-warning float-right btn-sm mt-4' to={"/solutions"}>LEARN MORE</Link>
                        </CardBody>
                      </Card>
                    </Col>
                  </Row>
